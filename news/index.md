...
- Nova função
  [`br_update_page_title()`](../reference/br_update_page_title.md):
...
- Acessibilidade: textos auxiliares (`hint`) agora associados aos inputs
  ...
  [`br_checkbox_input()`](../reference/br_checkbox_input.md) e
  [`br_select_input()`](../reference/br_select_input.md) (cherry-pick do
  upstream).
...
- Nova família de componentes `br_*` construída com os assets oficiais
  ...
  [`use_govbr()`](../reference/use_govbr.md),
  [`br_header()`](../reference/br_header.md),
  [`br_footer()`](../reference/br_footer.md),
  [`br_layout()`](../reference/br_layout.md),
  [`br_button()`](../reference/br_button.md),
  [`br_text_input()`](../reference/br_text_input.md),
  [`br_textarea_input()`](../reference/br_textarea_input.md),
  [`br_date_input()`](../reference/br_date_input.md),
  [`br_select_input()`](../reference/br_select_input.md),
  [`br_checkbox_input()`](../reference/br_checkbox_input.md),
  [`br_radio_input()`](../reference/br_radio_input.md),
  [`br_message()`](../reference/br_message.md),
  [`br_tag()`](../reference/br_tag.md),
  [`br_divider()`](../reference/br_divider.md) e
