test_that("footer links add correctly", {
  ...
  # shiny >= 1.10.1 envolve o rotulo em <span class="action-label">
  expect_match(html, "Accessibility Statement</(span|a)>")
  expect_match(html, "Cookies</(span|a)>")
  ...
  expect_match(html_full, "Privacy Notice</(span|a)>")
