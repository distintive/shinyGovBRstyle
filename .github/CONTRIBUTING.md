...
Ideias e correções devem primeiro ser registradas como uma
[issue no GitHub](https://github.com/DistintiveLab/shinyGovBRstyle/issues);
em seguida qualquer pessoa pode escrever o código e abrir um pull request
para revisão.

Para apoio sobre desenvolvimento de pacotes em R, recomendamos o guia
...
- **Família legada (derivada do GOV.UK)**: depreciada desde a versão
  0.2.0 (emite aviso) e programada para remoção. Não adicione recursos
  a ela.
...
5. Atualize `NEWS.md` e, se o componente mudar visualmente, o `README.md`.
